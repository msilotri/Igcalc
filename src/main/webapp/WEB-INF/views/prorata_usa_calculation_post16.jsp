...
<main id="content" role="main">
	...
	<div class="grid-row">
		<form:form action="select_calculation_prorata_eu" method="post" modelAttribute="post16UsaDetails">
			...
			<div style="overflow: auto;" class="form-group">
				<table class="tableWithBorder" id="proRataUsaTablePost75">
					<c:forEach items="${post16UsaDetails.listOfInsuranceRecords}" var="post75InsuranceRecord" varStatus="x" begin="0">
						<tbody>
							<tr>
								<th>Country (a)</th>
								<th>From (b)</th>
					...
					<c:if test="${post16UsaDetails.listOfInsuranceRecords.size() == 0}">
						<tbody>
							<tr>
								<th>Country (a)</th>
								<th>From (b)</th>
			...
			<input type="button" id="proRataUsaPost16BackBtn" name="proRataUsaPost16BackBtn" class="button" alt="Back" value="Back" onclick="return goBack(this);" />
			<input type="submit" name="proRataUsaPost16SubmitBtn" class="button" alt="Continue" value="Continue" />
