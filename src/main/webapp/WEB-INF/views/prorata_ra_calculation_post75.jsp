...
<main id="content" role="main">
	...
	<div class="grid-row">
		<form:form action="prorata_ra_calculation_post16" method="post" modelAttribute="post75RaDetails">
			...
			<div style="overflow: auto;" class="form-group">
				<table class="tableWithBorder" id="proRataEuraTablePost75">
					<c:forEach items="${post75RaDetails.listOfInsuranceRecords}" var="post75InsuranceRecord" varStatus="x" begin="0">
						<tbody>
							<tr>
					...
					<c:if test="${post75RaDetails.listOfInsuranceRecords.size() == 0}">
						<tbody>
							<tr>
								<th colspan="3">Country (a)</th>
							</tr>
			...
			<input type="button" id="proRataRaPost75BackBtn" name="proRataRaPost75BackBtn" class="button" alt="Back" value="Back" onclick="return goBack(this);" />
			<input type="submit" name="proRataRaPost75SubmitBtn" class="button" alt="Continue" value="Continue" />
