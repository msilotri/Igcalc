...
<main id="content" role="main">
	...
	<h1 class="heading-xlarge">nSP Pro Rata Calculation EU Countries</h1>

	<div class="grid-row">
		<form:form action="prorata_eu_calculation_post16" method="post" modelAttribute="post75EuDetails">

			<label class="form-label-bold with-space">Record of insurance from <form:input path="fromPost75" class="datepicker" size="12" title="This should be in the format dd/mm/yyyy" /> to <form:input path="toPost75" size="12" readonly="true" /></label>
			<div style="overflow: auto;" class="form-group">
				<table class="tableWithBorder" id="proRataEuraTablePost75">
					<c:forEach items="${post75EuDetails.listOfInsuranceRecords}" var="post75InsuranceRecord" varStatus="x" begin="0">
						<tbody>
							<tr>
					...
					<c:if test="${post75EuDetails.listOfInsuranceRecords.size() == 0}">
						<tbody>
							<tr>
								<th colspan="3">Country (a)</th>
							</tr>
			...
			<input type="button" id="proRataEuPost75BackBtn" name="proRataEuPost75BackBtn" class="button" alt="Back" value="Back" onclick="return goBack(this);" />
			<input type="submit" name="proRataEuPost75SubmitBtn" class="button" alt="Continue" value="Continue" />
