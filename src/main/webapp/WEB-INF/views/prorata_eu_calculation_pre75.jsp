...
<main id="content" role="main">
	...
	<div class="grid-row">
		<form:form action="prorata_eu_calculation_post75" method="post" modelAttribute="pre75EuDetails">
			...
			<table class="tableWithBorder" id="proRataTablePre75">
				<c:forEach items="${pre75EuDetails.listOfInsuranceRecords}" var="pre75InsuranceRecord" varStatus="x" begin="0">
					<tbody>
						<tr>
				...
				<c:if test="${pre75EuDetails.listOfInsuranceRecords.size() == 0}">
					<tbody>
						<tr>
							<th colspan="3">Country</th>
						</tr>
			...
			<div class="form-group">
				<input type="submit" name="proRataEuPre75SubmitBtn" class="button" alt="Continue" value="Continue" />
			</div>
