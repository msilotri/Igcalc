...
<main id="content" role="main">
	...
	<div class="grid-row">
		<form:form action="select_calculation_prorata_eu" method="post" modelAttribute="post16EuDetails">
			...
			<div style="overflow: auto;" class="form-group">
				<table class="tableWithBorder" id="proRataEuraTablePost75">
					<c:forEach items="${post16EuDetails.listOfInsuranceRecords}" var="post75InsuranceRecord" varStatus="x" begin="0">
						<tbody>
							<tr>
					...
					<c:if test="${post16EuDetails.listOfInsuranceRecords.size() == 0}">
						<tbody>
							<tr>
								<th colspan="3">Country (a)</th>
							</tr>
			...
			<input type="button" id="proRataEuPost16BackBtn" name="proRataEuPost16BackBtn" class="button" alt="Back" value="Back" onclick="return goBack(this);" />
			<input type="submit" name="proRataEuPost16SubmitBtn" class="button" alt="Continue" value="Continue" />
