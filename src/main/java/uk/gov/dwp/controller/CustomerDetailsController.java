...
public class CustomerDetailsController {
	...
	private Map<String, String> populateCountries() {
	...
	public String showCustomerDetails(Model model, @ModelAttribute(Constants.CUSTOMER_DETAILS) CustomerDetails customerDetails,
			HttpSession session) {
	...
	public String showPartnerDetails(Model model, @ModelAttribute(Constants.PARTNER_DETAILS) PartnerDetails partnerDetails,
			HttpSession session) {
	...
	public String submitCustomerDetailsGoToPartner(@ModelAttribute(Constants.CUSTOMER_DETAILS) CustomerDetails customerDetails,
			HttpSession session) {
